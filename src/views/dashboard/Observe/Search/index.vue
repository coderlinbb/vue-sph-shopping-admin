<template>
  <el-card>
    ...
    <div>
      ...
      <!-- table表格 -->
      <el-table :data="tableData" style="width: 100%;margin:30px 0" border>
      ...
      <!-- 分页去 -->
      <el-pagination layout="prev, pager, next" :total="1000" class="pagination" style="margin-bottom:20px"> </el-pagination>
    </div>
  </el-card>
</template>
